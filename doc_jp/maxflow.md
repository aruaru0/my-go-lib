...
有向グラフネットワークにおいて、始点から終点へ流すことができる最大流量を求める、汎用的な最大流データ構造とアルゴリズムです。

## 主なユースケース（どういう時に使うか）

- 輸送ルートのボトルネック特定や最大輸送能力の計測
- 複数ソースから複数デスティネーションへの効率的な配分
- **各種割り当て問題（マッチング）や最小カット問題への応用**

## なぜ使うのか（メリット）

- グラフ構造を構築して最大流を実行するだけで、多様な組合せ最適化問題を系統的に解くことができます。
